...
var urlgetObjTemplates = 'http://'+servidorRuby+'/template_list/';
...
function urlLinestring(piso, loja, layer){
  ...
  return 'http://'+ servidor +'/geoserver/brMalls/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=brMalls:vw_linestring&outputFormat=application%2Fjson&viewparams=floor:'+piso+';loja:'+loja +';layer:'+ layer; //Geoserver URL  
